    ...
    <div class="carousel-inner">              
           <div class="carousel-item active">
            ...
            <form action="ServletCertificados">
                <h2 class="form__titulo">Entrada Insumos</h2>
                 ...
                 <thead>
                  ...
                  <?php
                      $conexion=mysqli_connect('localhost','root','','Ingeambiental');
                         $sql="SELECT * FROM entradas_insumos";
       ...
       <div class="botones">
        ...
        <a class="salida"href="Salida_Insumos.php" class="btn btn-success"><i class="fas fa-door-open"></i>Salidas</a>
