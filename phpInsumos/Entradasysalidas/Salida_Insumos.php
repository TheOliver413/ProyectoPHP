    ...
    <div class="carousel-inner">              
           <div class="carousel-item active">
            ...
            <form action="ServletCertificados">
                <h2 class="form__titulo">Salida Insumos</h2>
                <div class="contendor-inputs">
                    <input type="hidden" id="num" name="num" placeholder="Id" class="input-48" required>
                    ...
                    <input type="number" id="producto" name="producto" placeholder="Producto" class="input-100" required>
                 ...
                 <thead>
                  ...
                  <?php
                      $conexion=mysqli_connect('localhost','root','','Ingeambiental');
                         $sql="SELECT * FROM salidas_insumos";
       ...
       <div class="botones">
        <a class="entrada"href="../Tabla_Insumos.php" class="btn btn-success"><i class="fas fa-archive"></i></i>Inventario</a>
        <a class="salida"href="Entrada_Insumos.php" class="btn btn-success"><i class="fas fa-door-closed"></i>Entradas</a>
