    ...
    <div class="carousel-inner">              
           <div class="carousel-item active">
            <form action="ServletCertificados">
                <h2 class="form__titulo">Insumos</h2>
                <div class="contendor-inputs">

                    <input type="hidden" id="codigo" name="codigo" placeholder="Codigo" class="input-48" required>
                    <input type="text" id="nombre" name="nombre" placeholder="Nombre De Insumo" class="input-48" required>
                  ...
                  <table style="border:1">
                   <thead>
                    ...
                    <?php
                      ...
                      <?php
                          echo"<td><a href='Modificar_Insumos.php?Num=".$mostrar['Num']."'><button type='button' class='actualizar'><i class='fas fa-pencil-alt'></i></button></a></td>";
       ...
       <div class="botones">
        <a class="entrada"href="Entradasysalidas/Entrada_Insumos.php" class="btn btn-success"><i class="fas fa-door-closed"></i>Entradas</a>
        <a class="salida"href="Entradasysalidas/Salida_Insumos.php"  class="btn btn-success"><i class="fas fa-door-open"></i>Salidas</a>
      </div>
