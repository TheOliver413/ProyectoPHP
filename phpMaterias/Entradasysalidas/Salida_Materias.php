    ...
    <div class="carousel-inner">              
           <div class="carousel-item active">
            ...
            <form action="ServletCertificados">
                <h2 class="form__titulo">Salidas Materias P.</h2>
                 ...
                 <thead>
                  ...
                  <?php
                      $conexion=mysqli_connect('localhost','root','','Ingeambiental');
                         $sql="SELECT * FROM salidas_primas";
       ...
       <div class="botones">
        <a class="entrada"href="../Tabla_Materias.php" class="btn btn-success"><i class="fas fa-archive"></i></i>Inventario</a>
        <a class="salida"href="Entrada_Materias.php" class="btn btn-success"><i class="fas fa-door-closed"></i>Entrada</a>
