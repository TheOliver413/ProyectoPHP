    ...
    <div class="carousel-inner">              
           <div class="carousel-item active">
            ...
            <form action="ServletCertificados">
                <h2 class="form__titulo">Entrada Materias P.</h2>
                 ...
                 <thead>
                  ...
                  <?php
                      $conexion=mysqli_connect('localhost','root','','Ingeambiental');
                         $sql="SELECT * FROM entradas_primas";
       ...
       <div class="botones">
        ...
        <a class="salida"href="Salida_Materias.php" class="btn btn-success"><i class="fas fa-door-open"></i>Salidas</a>
