...
function ConsultarLaboratorio($Num)
{
    ...
    $sentencia="SELECT * FROM materiasprimas WHERE num='".$Num."' ";
...
<div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
    <div class="carousel-inner">              
           <div class="carousel-item active">
            <form action="Modificar_Materias2.php" method="POST">
                <h2 class="form__titulo"> Actualizar Materias Primas</h2>
                <div class="contendor-inputs">
                  <input type="hidden" id="num" name="num" placeholder="Unidades" class="input-48"value="<?php echo $consulta[0]?>" required>
                <input type="text" id="nombre" name="nombre" placeholder="Nombre De Materia" class="input-48" value="<?php echo $consulta[1]?>"required>
       ...
       <div class="botones">
        <a class="entrada"href="Tabla_EntradaMateria.php" class="btn btn-success"><i class="fas fa-door-closed"></i>Entradas</a>
        <a class="salida"href="Tabla_SalidaMateria.php" class="btn btn-success"><i class="fas fa-door-open"></i>Salidas</a>
      </div>
