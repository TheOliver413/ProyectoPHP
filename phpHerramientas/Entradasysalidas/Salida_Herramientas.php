    ...
    <div class="carousel-inner">              
           <div class="carousel-item active">
            ...
            <form action="ServletCertificados">
                <h2 class="form__titulo">Salida Herramientas</h2>
                  ...
                  <tbody>
                   <?php
                      $conexion=mysqli_connect('localhost','root','','Ingeambiental');
                         $sql="SELECT * FROM salidas_herramientas";
       ...
       <div class="botones">
        <a class="entrada"href="../Tabla_Herramientas.php" class="btn btn-success"><i class="fas fa-archive"></i></i>Inventario</a>
        <a class="salida"href="Entrada_Herramientas.php" class="btn btn-success"><i class="fas fa-door-closed"></i>Entrada</a>
