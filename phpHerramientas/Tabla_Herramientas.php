...
<div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
    <div class="carousel-inner">              
                 ...
                 <thead>
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <?php
                          echo"<td><a href='Modificar_Herramienta.php?Num=".$mostrar['Num']."'><button type='button' class='actualizar'><i class='fas fa-pencil-alt'></i></button></a></td>";
       ...
       <div class="botones">
        <a class="entrada"href="EntradaHerramientas.html" class="btn btn-success"><i class="fas fa-door-closed"></i>Entradas</a>
        <a class="salida"href="SalidaHerramientas.html" class="btn btn-success"><i class="fas fa-door-open"></i>Salidas</a>
