<?php
    ...
    try {
        ...
        if($anio !=0){
            $pastel = $conn->query("select YEAR(Fecha) AS Año, SUM(Unidades) AS Unidades,Cedula FROM entradas_laboratorio WHERE YEAR(Fecha)='$anio' AND Cedula='1003742061' GROUP BY YEAR(Fecha);");
        ...
        ?>
            google.setOnLoadCallback(drawChartPastel);
                function drawChartPastel(){
                    ...
                    var option={
                        title: 'Unidades ingresadas en el año especificado',
                        is3D: 'true',
                        width: 900,
                        height:700
                    };
...
<body>
            <div class="container">
                <h1>Consulta de unidades ingresadas al inventario de laboratorio <?php if($anio !=0 ) echo "en " .$anio; else{ echo "Según año";} ?></h1>
                <form method="post">
                    <div>
