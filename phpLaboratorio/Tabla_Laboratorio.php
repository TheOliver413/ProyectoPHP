    ...
    <div class="carousel-inner">              
           <div class="carousel-item active">
            ...
            <form action="ServletCertificados">
                <h2 class="form__titulo">Laboratorio</h2>
                <div class="contendor-inputs">
                  <input type="hidden" id="num" name="num" placeholder="num" class="input-48" required>
                    ...
                    <input type="text" id="marca" name="marca" placeholder="marca" class="input-48" required>
                    <input type="number" id="referencia" name="referencia" placeholder="referencia" class="input-48"required>
                  ...
                  <table style="border:1">
                   <thead>
                    ...
                    <?php
                      ...
                      <?php
                          echo"<td><a href='Modificar_Laboratorio.php?Num=".$mostrar['Num']."'><button type='button' class='actualizar'><i class='fas fa-pencil-alt'></i></button></a></td>";
       ...
       <div class="botones">
        <a class="entrada"href="Entradasysalidas/Entrada_Laboratorio.php" class="btn btn-success"><i class="fas fa-door-closed"></i>Entradas</a>
