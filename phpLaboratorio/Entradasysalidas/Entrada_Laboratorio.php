    ...
    <div class="carousel-inner">              
           <div class="carousel-item active">
            ...
            <form action="ServletCertificados">
                <h2 class="form__titulo">Entrada Laboratorio</h2>
                 ...
                 <thead>
                  ...
                  <?php
                      $conexion=mysqli_connect('localhost','root','','Ingeambiental');
                         $sql="SELECT * FROM entradas_laboratorio";
       ...
       <div class="botones">
        ...
        <a class="salida"href="Salida_Laboratorio.php" class="btn btn-success"><i class="fas fa-door-open"></i>Salidas</a>
